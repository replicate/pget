...
func (m *ConsistentHashingMode) getFileSizeFromResponse(resp *http.Response) (int64, error) {
...
func (m *ConsistentHashingMode) getFileSizeFromContentLength(contentLength string) (int64, error) {
